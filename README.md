...
* @mainpage Advanced Camera System plugin
* ### Unreal Engine 5.7
...
* On the Playercharacter added the interface : BPI\_Pawn. And added The SpringArmComponentACS as the default springArm for the camera.
